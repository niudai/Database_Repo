...
describe('Service Tests', () => {
  describe('Major Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(MajorService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Major(0, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Major', () => {
        ...
        service.create(new Major()).subscribe(resp => (expectedResult = resp.body));
